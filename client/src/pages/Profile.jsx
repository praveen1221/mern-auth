...
import { deleteSuccess, signInFailure, signInStart, signInSuccess } from '../redux/user/userSlice';
...
export default function Profile() {
  ...
  const { currentUser, loader, errorMsg } = useSelector((state) => state.user);
    ...
    <div className='p-1 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        ...
        <img
          ...
          alt='profile'
          title='Click here to change the Image'
        ...
        <input
          ...
          onChange={onHandleChange}
        />
        <button disabled={loader} className='bg-slate-700 text-white p-3 rounded-lg uppercase hover:opacity-95'>
